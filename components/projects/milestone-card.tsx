import { Calendar, Layers, CheckCircle, Clock, AlertCircle } from "lucide-react";
...
export function MilestoneCard({
  ...
  const dateRange = formatDateRange(milestone.created_at, milestone.due_date);
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-start mb-1">
            ...
            <span className={cn("text-xs font-bold shrink-0 ml-4", config.badgeStyle)}>
              {config.badge}
